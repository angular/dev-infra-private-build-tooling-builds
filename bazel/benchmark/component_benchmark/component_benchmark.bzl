...
def copy_default_index_html(output_name, bundle_target_name):
    ...
    expand_template(
        ...
        template = "@npm//@angular/build-tooling/bazel/benchmark/component_benchmark/defaults:index-template.html",
...
def copy_default_file(origin, destination):
    ...
    native.genrule(
        ...
        srcs = ["@npm//@angular/build-tooling/bazel/benchmark/component_benchmark/defaults:" + origin],
        outs = [destination],
        cmd = "cat $(SRCS) >> $@",
    )
...
def component_benchmark(
    ...
    ** USAGE NOTES **
    ...
    http_server(
        ...
        additional_root_paths = ["@npm//@angular/build-tooling/bazel/benchmark/component_benchmark/defaults"],
    )
