...
load("@npm//@angular/build-tooling/bazel/browsers/chromium:chromium.bzl", "define_chromium_repositories")
load("@npm//@angular/build-tooling/bazel/browsers/firefox:firefox.bzl", "define_firefox_repositories")
