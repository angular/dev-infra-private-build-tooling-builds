...
load("@npm//@angular/build-tooling/bazel/esbuild:index.bzl", "esbuild", "esbuild_amd", "esbuild_config", "esbuild_esm_bundle")
load("@npm//@angular/build-tooling/bazel/spec-bundling:spec-entrypoint.bzl", "spec_entrypoint")
load("@npm//@angular/build-tooling/bazel/spec-bundling:bundle-config.bzl", "spec_bundle_config_file")
...
def spec_bundle(
    ...
    if run_angular_linker or downlevel_async_await:
        esbuild_config_deps = ["@npm//@angular/build-tooling/shared-scripts/angular-optimization:js_lib"]
