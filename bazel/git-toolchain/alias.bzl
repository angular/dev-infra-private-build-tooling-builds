def _git_toolchain_alias_impl(ctx):
    toolchain = ctx.toolchains["@npm//@angular/build-tooling/bazel/git-toolchain:toolchain_type"]
...
git_toolchain_alias = rule(
    ...
    toolchains = ["@npm//@angular/build-tooling/bazel/git-toolchain:toolchain_type"],
    doc = """
