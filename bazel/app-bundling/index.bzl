...
def app_bundle(
    ...
    expand_template(
        ...
        template = "@npm//@angular/build-tooling/bazel/app-bundling:esbuild.config-tmpl.mjs",
        substitutions = {
    ...
    common_terser_options = dict({
        "config_file": "@npm//@angular/build-tooling/bazel/app-bundling:terser_config.json",
        "sourcemap": True,
    }, **common_base_attributes)
    ...
    npm_package_bin(
        ...
        tool = "@npm//@angular/build-tooling/bazel/app-bundling:brotli-compress",
        data = [name + ".min.js"],
        outs = [name + ".min.js.br"],
        args = [
