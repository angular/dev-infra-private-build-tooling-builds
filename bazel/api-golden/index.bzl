...
def api_golden_test(
    ...
    test_data = ["@npm//@angular/build-tooling/bazel/api-golden", "//:package.json", ":%s_data_typings" % name] + \
                data + types

    nodejs_test(
        name = name,
        data = test_data,
        entry_point = "@npm//@angular/build-tooling/bazel/api-golden:index.ts",
...
def api_golden_test_npm_package(
    ...
    nodejs_test(
        name = name,
        data = ["@npm//@angular/build-tooling/bazel/api-golden"] + data + types,
        entry_point = "@npm//@angular/build-tooling/bazel/api-golden:index_npm_packages.ts",
